  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <div className='flex justify-end items-center mb-8'>
            <button className='rounded p-3 mr-2 bg-gray-200 cursor-pointer' aria-label='Previous Projects'>
                <img src={ assets.left_arrow } alt="Previous" />
            </button>
             <button className='rounded p-3 mr-2 bg-gray-200 cursor-pointer' aria-label='Next Projects'>
